...
type GeeNacosRegister struct {
	cli naming_client.INamingClient
}

func (r *GeeNacosRegister) CreateCli(option Option) error {
...
func (r *GeeNacosRegister) RegisterService(serviceName string, host string, port int) error {
...
func (r *GeeNacosRegister) GetValue(serviceName string) (string, error) {
...
func (r *GeeNacosRegister) Close() error {
	return nil
}
